...
class Message(TruncatedMessage):
    ...
    async def fetch_audios(self, api: API, attachments: dict = None) -> typing.List[Audio]:
        """
    ...
    async def fetch_audio_message(self, api: API, attachments: dict = None) -> AudioMsg:
        """
    ...
    async def fetch_videos(self, api: API, attachments: dict = None) -> typing.List[Video]:
        """
    ...
    async def fetch_photos(self, api: API, attachments: dict = None) -> typing.List[Photo]:
        """
    ...
    async def fetch_docs(self, api: API, attachments: dict = None) -> typing.List[Document]:
        """
